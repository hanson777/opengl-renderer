...
void Texture::loadTextureImage(std::string filename) {
    ...
    setTexture(data, format, width, height);        
    stbi_image_free(data);
}

void Texture::setTexture(uint8_t* data, GLenum format, int width, int height) {
